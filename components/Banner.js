...
const Banner = () => {
    return (
        <section className='search-banner bg-rappi-orange text-white text-center h-64 flex flex-col items-center justify-center px-7'>
            <h1 className="text-4xl font-thin mb-10">Si tienes <strong className="font-black">Rappi,</strong> tienes Todo.</h1>
